...
DEFAULT_INDEX_PATH = PROJECT_ROOT / "data" / "reference" / "umls" / "quickumls_index"

_MATCHER = None


def _get_matcher(index_path: Path = DEFAULT_INDEX_PATH,
                 threshold: float = 0.7,
...
def is_available(index_path: Path = DEFAULT_INDEX_PATH) -> bool:
